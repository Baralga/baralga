...
public class ManageProjectsDialog extends JDialog {
    ...
    private JButton getAddProjectButton() {
        if (addProjectButton == null) {
            addProjectButton = new JButton(new ImageIcon(getClass().getResource("/resource/icons/gtk-add.png")));
    ...
    private JButton getRemoveProjectButton() {
        if (removeProjectButton == null) {
            removeProjectButton = new JButton(new ImageIcon(getClass().getResource("/resource/icons/gtk-stop.png")));
