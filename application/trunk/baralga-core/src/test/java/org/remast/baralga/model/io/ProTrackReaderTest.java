...
public class ProTrackReaderTest {
     ...
     */
    @Test
    public void testProTrackReadLegacyDataV144() throws IOException {
        InputStream in = ProTrackReaderTest.class.getResourceAsStream("/ProTrack_legacy_V1.4.4.ptd.xml");
        assertNotNull(in);
